<%-- 
    ...
    Created on : 4-mag-2017, 22.41.50
    Author     : Cristian
--%>
...
<html>
    ...
    <head>
        <title>.:NerdBook : Connect the future:.</title>
        <meta charset="UTF-8">
